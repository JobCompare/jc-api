...
describe('Logger', () => {
  ...
  describe('#trace()', () => {
    it('should not execute console.trace when level is \'hide\'', () => {
      logger.level = 'hide';
      logger.trace();
      assert.ok(stubs.console.trace.notCalled);
    });

    it('should execute console.trace when level is \'trace\'', () => {
      logger.level = 'trace';
      logger.trace();
  ...
  describe('#debug()', () => {
    ...
    it('should execute console.trace when level is \'debug\'', () => {
      logger.level = 'debug';
      logger.debug();
      assert.ok(stubs.console.trace.calledOnce);
    });
  ...
  describe('#info()', () => {
    it('should not execute console.info when level is \'hide\'', () => {
      logger.level = 'hide';
      logger.info();
      assert.ok(stubs.console.info.notCalled);
    });

    it('should execute console.info when level is \'info\'', () => {
      logger.level = 'info';
      logger.info();
  ...
  describe('#warn()', () => {
    it('should not execute console.warn when level is \'hide\'', () => {
      logger.level = 'hide';
      logger.warn();
      assert.ok(stubs.console.warn.notCalled);
    });

    it('should execute console.warn when level is \'warn\'', () => {
      logger.level = 'warn';
      logger.warn();
  ...
  describe('#error()', () => {
    it('should not execute console.error when level is \'hide\'', () => {
      logger.level = 'hide';
      logger.error();
      assert.ok(stubs.console.error.notCalled);
    });

    it('should execute console.error when level is \'error\'', () => {
      logger.level = 'error';
      logger.error();
  ...
  describe('#fatal()', () => {
    ...
    it('should execute console.error when level is \'fatal\'', () => {
      logger.level = 'fatal';
      logger.fatal();
      assert.ok(stubs.console.error.calledOnce);
    });
  ...
  describe('logger.level = \'show\'', () => {
    it('should execute logger at any level', () => {
      logger.level = 'show';

      logger.error();
      logger.fatal();

      assert.ok(stubs.console.error.calledTwice);
      ...
      assert.ok(stubs.console.trace.calledTwice);
